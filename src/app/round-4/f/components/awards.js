...
export default function Awards() {
  return (
    <div className="bg-transparent text-neutrals-black py-20">
      <div className="max-w-wrapper space-y-6">
        <div className="">
          <h2 className="text-5xl text-cardinal-red inline-block tracking-tight font-bold mb-6 text-balance !my-0 mr-auto">Celebrating People Who Lead</h2>
        </div>
