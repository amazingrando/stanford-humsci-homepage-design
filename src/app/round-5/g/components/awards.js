...
export default function Awards() {
  return (
    <div className="bg-transparent text-neutrals-black pb-20">
      <div className="max-w-wrapper space-y-6">
        <div className="">
          <h2 className="text-5xl text-cardinal-red inline-block tracking-tight font-bold mb-6 text-balance !my-0 mr-auto">Celebrating Excellence in Humanities and Sciences</h2>
        </div>
        ...
        <div className="grid grid-cols-12 gap-16">
          ...
          <div className="space-y-4 divide-y divide-black-30 col-span-5">
            ...
            <Button>Explore all awards</Button>
          </div>
        </div>
      </div>
    </div>
